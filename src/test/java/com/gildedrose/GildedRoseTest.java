...
public class GildedRoseTest {
    ...
    public void decrease_quality_and_sellIn_values_for_each_item_at_the_Eof() {
        ...
        gr = createGrWithOneItem("Any Item", SELLIN_VALUE, QUALITY_VALUE);
        gr.updateQuality();
    ...
    public void decrease_quality_By1_if_sellIn_date_has_passed_at_the_Eof() {
        gr = createGrWithOneItem("Any Item", SELLIN_VALUE_NULL, QUALITY_VALUE);
        gr.updateQuality();
    ...
    public void quality_should_be_never_negative_at_the_Eof() {
        gr = createGrWithOneItem("Any Item", SELLIN_VALUE, QUALITY_VALUE_NULL);
        gr.updateQuality();
        Assertions.assertEquals(SELLIN_VALUE - 1, getFirstItem().sellIn);
    ...
    public void agedBrie_should_increase_quality_at_the_Eof() {
        gr = createGrWithOneItem("Aged Brie", SELLIN_VALUE, QUALITY_VALUE);
        gr.updateQuality();
        Assertions.assertEquals(SELLIN_VALUE - 1, getFirstItem().sellIn);
        Assertions.assertEquals(QUALITY_VALUE + 1, getFirstItem().quality);
    }
    ...
    public void agedBrie_should_increaseBy2_if_sellIn_values_has_passed_at_the_Eof() {
        gr = createGrWithOneItem("Aged Brie", SELLIN_VALUE_NULL, QUALITY_VALUE);
        gr.updateQuality();
        Assertions.assertEquals(SELLIN_VALUE_NULL - 1, getFirstItem().sellIn);
        Assertions.assertEquals(QUALITY_VALUE + 2, getFirstItem().quality);
    }
    ...
    public void quality_should_be_never_more_50_at_the_Eof() {
        gr = createGrWithOneItem("Aged Brie", SELLIN_VALUE, QUALITY_MAX_VALUE);
        gr.updateQuality();
        Assertions.assertEquals(SELLIN_VALUE - 1, getFirstItem().sellIn);
    ...
    public void quality_should_be_never_more_50_even_sellin_passed_at_the_Eof() {
        gr = createGrWithOneItem("Aged Brie", SELLIN_VALUE_NULL, QUALITY_MAX_VALUE - 1);
        gr.updateQuality();
        Assertions.assertEquals(SELLIN_VALUE_NULL - 1, getFirstItem().sellIn);
        Assertions.assertEquals(QUALITY_MAX_VALUE, getFirstItem().quality);
    }
    ...
    public void quality_should_be_null_if_sellin_date_passed_at_the_Eof() {
        gr = createGrWithOneItem("foo", SELLIN_VALUE_NULL , QUALITY_VALUE);
        gr.updateQuality();
        Assertions.assertEquals(SELLIN_VALUE_NULL - 1, getFirstItem().sellIn);
        Assertions.assertEquals(QUALITY_VALUE - 2, getFirstItem().quality);
    }
    ...
    public void sulfuras_quality_should_be_never_decreases_at_the_Eof() {
        gr = createGrWithOneItem("Sulfuras, Hand of Ragnaros", SELLIN_VALUE, QUALITY_VALUE);
        gr.updateQuality();
    ...
    public void backstage_quality_should_increaseBy1_MoreThan10Days_at_the_Eof() {
        gr = createGrWithOneItem("Backstage passes to a TAFKAL80ETC concert", SELLIN_VALUE, QUALITY_VALUE);
        gr.updateQuality();
        Assertions.assertEquals(SELLIN_VALUE - 1, getFirstItem().sellIn);
        Assertions.assertEquals(QUALITY_VALUE + 1, getFirstItem().quality);
    }
    ...
    public void backstage_quality_should_increaseBy2_lessOrEqualThan_10Days_at_the_Eof() {
        gr = createGrWithOneItem("Backstage passes to a TAFKAL80ETC concert", SELLIN_VALUE_10, QUALITY_VALUE);
        gr.updateQuality();
    ...
    public void backstage_quality_should_increaseBy3_lessOrEqualThan_5Days_at_the_Eof() {
        gr = createGrWithOneItem("Backstage passes to a TAFKAL80ETC concert", SELLIN_VALUE_5, QUALITY_VALUE);
        gr.updateQuality();
    ...
    public void backstage_quality_should_dropToZero_after_concert_at_the_Eof() {
        gr = createGrWithOneItem("Backstage passes to a TAFKAL80ETC concert", SELLIN_VALUE_NULL, QUALITY_VALUE);
        gr.updateQuality();
        Assertions.assertEquals(SELLIN_VALUE_NULL - 1, getFirstItem().sellIn);
        Assertions.assertEquals(QUALITY_VALUE_NULL, getFirstItem().quality);
    }
    ...
    public void backstage_quality_should_IncreasesBy2MoreThan5DaysFromConcert() {
        gr = createGrWithOneItem("Backstage passes to a TAFKAL80ETC concert", SELLIN_VALUE_5 + 1, QUALITY_VALUE);
        gr.updateQuality();
        Assertions.assertEquals(QUALITY_VALUE + 2, getFirstItem().quality );
    }
    @Test
    public void backstage_quality_should_be_never_more_50_at_the_Eof() {
        gr = createGrWithOneItem("Backstage passes to a TAFKAL80ETC concert", SELLIN_VALUE_5, QUALITY_MAX_VALUE-1);
        gr.updateQuality();
        Assertions.assertEquals(QUALITY_MAX_VALUE, getFirstItem().quality);
    }
    @Test
